...
```
[Click here to watch a brief video overview of our project!](https://drive.google.com/file/d/1kDCkuSsnA0zlpNz1E3sZytzUpFR0QYg-/view?usp=sharing)
...
plot_race_rent <- function(data) {
  ggplot(data) +
    ...
    labs(
      title = "Median Rent by State, Faceted by Race, Compared throughout US",
    ...
    facet_wrap(~ race, nrow = 2, ncol = 3, labeller = labeller(
      race = c(
        white_alone = "White Alone",
        black_alone = "Black Alone ",
        asian_alone = "Asian Alone ",
        amer_indian_alone = "American Indian Alone",
        other_race_alone = "Other Race",
