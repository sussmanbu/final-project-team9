...
>>>>>>> 1f18dd3a95c9377fa937b0088fd3d00042474cea
...
ggplot(race_counts, aes(x = factor(Abbr_RACE), y = Count, fill = factor(RACE))) +
  geom_bar(stat = "identity", color = "#95A5A6") + 
  geom_text(aes(label = sprintf("%1.1f%%", Percentage), y = Count + 50), 
            vjust = -0.3, size = 3.5, color = "#34495E") + 
  theme_minimal(base_size = 15) +  
  theme(
    plot.title = element_text(hjust = 0.5, size = 15, face = "bold", color = "#34495E"), 
    axis.title = element_text(size = 10, face = "bold", color = "#34495E"),  
  ...
  labs(
    title = "Distribution of Racial Groups",
    x = "Racial Group",
    y = "Number of People",
    caption = "Data Source: IPUMS"  
  ) +
  scale_fill_manual(
    values = c("#FFB6C1", "#FFA07A", "#FFD700", "#98FB98", "#87CEFA", "#FF69B4", "#BA55D3", "#FFDAB9", "#40E0D0", "#F08080", "#E6E6FA", "#FFFFE0"),
    name = "Racial Group"
  )
