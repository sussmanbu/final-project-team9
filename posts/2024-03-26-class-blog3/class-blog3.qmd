...
p <- ggplot(rent_data_clean, aes(x = POVERTY)) +
  ...
  labs(title = "Histogram of Poverty Scores",
       x = "Poverty Score",
       y = "Frequency")
p <- p + geom_vline(xintercept = 1, color = "blue", linetype = "dashed", size = 1) +
  geom_text(aes(x = 1, y = Inf, label = "001 = ≤1% of poverty threshold"), angle = 90, hjust = 1, vjust = 2, color = "blue") +
  geom_vline(xintercept = 501, color = "red", linetype = "dashed", size = 1) +
  geom_text(aes(x = 501, y = Inf, label = "501 = ≥501% of poverty threshold"), angle = 90, hjust = 1, vjust = 2, color = "red")
