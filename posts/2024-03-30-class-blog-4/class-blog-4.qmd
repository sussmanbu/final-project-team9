---
title: "Class blog 4: Models"
subtitle: "Different models were applied to the dataset, including simple linear, multiple linear, log-log, and log-log with interaction, allowing for refined analysis and exploration of model fit."
...
## Log-log model
Based on the previous MLR model, 
