...
write_csv(rent_data_clean, file = here("dataset", "twentyyear_rent.csv"))
saveRDS(rent_data_clean, file = here("dataset", "twentyyear_rent.RData"))
saveRDS(rent_data_clean, file = here("dataset", "twentyyear_rent.rds"))
```
