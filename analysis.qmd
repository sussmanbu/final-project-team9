...
### Model Findings:
[Click the link to see the ](https://yatingzhu.shinyapps.io/app1/)
...
```
[link to the finding]( https://yatingzhu.shinyapps.io/app2/)
...
[Check out my Shiny app!] (https://yatingzhu.shinyapps.io/app3/)
...
### Model Findings:
[Linked to model findings](https://yatingzhu.shinyapps.io/app3/)
...
[Linked to model findings](https://yatingzhu.shinyapps.io/app4/)
...
### Statistical Performance:
[Linked to model findings](https://yatingzhu.shinyapps.io/app5/)
```{r echo=FALSE, message=FALSE, warning=FALSE}
data_twenty[categorical_vars] <- lapply(data_twenty[categorical_vars], factor)
